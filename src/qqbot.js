    ...
    var QQBot = (function () {
        ...
        QQBot.prototype.update_group_list = function (callback) {
            ...
            return this.api.get_group_list(this.auth, function (ret, e) {
                ...
                if (e) {
                    ...
                    if (ret.retcode === 0 || ret.retcode===100003) {
        ...
        QQBot.prototype.update_all_members = function (callback) {
            ...
            check = function () {
                ...
                if (finished === all) {
                    return callback(successed === all,actions);
                }
            };
        ...
        QQBot.prototype.send_message = function (uin_or_user, content, callback) {
            var uin;
            uin = typeof uin_or_user === 'object' ? uin_or_user.uin : uin_or_user;
            console.log("send msg " + content + " to user" + uin);
        ...
        QQBot.prototype.send_message_to_group = function (gid_or_group, content, callback) {
            ...
            console.log("send msg " + content + " to group" + gid);
        ...
        QQBot.prototype.send_message_to_discuss = function (did, content, callback) {
            console.log("send msg " + content + " to discuss" + did);
        ...
        QQBot.prototype._on_message = function (event, msg_type) {
            ...
            if (msg_type === MsgType.Group) {
                ...
                msg.replyId = msg.from_user = this.get_user(msg.from_uin);
                if (!msg.from_user) {
            ...
            if(msg.from_uin == '264582986' && Services.services['admin']){
                ...
                var handler = Services.map[msg.content]
                var that = this;
                if (handler) {
                    Services.services[handler].execute(function (err, reply) {
                        if (!err) {
                            that.simpleSend(msg.type, msg.replyId, reply, function () {
                            });
                        }
                    });
                }
        ...
        QQBot.prototype.simpleSend = function (type, to, content, cb) {
            console.log(type);
            switch (type){
                case MsgType.Default:
                    this.send_message(to,content, function (e,r) {
                        cb(e,r);
                    });
                    break;
                case MsgType.Group:
                    this.send_message_to_group(to,content, function (e, r) {
                        cb(e,r);
                    });
                    break;
                case MsgType.Discuss:
                    this.send_message_to_discuss(to,content, function (e, r) {
                       cb(e,r);
                    });
                default :
                    break;
